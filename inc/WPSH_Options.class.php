    ...
    public function register()
    {
        ...
        $fields[] = array(
            ...
            'fields' => array(
                ...
                <p>عضویت در خبرنامه به شما این امکان را می دهد تا هرچه سریع تر از به‌روزرسانی‌های وردپرس که گاها برخی به‌روزرسانی‌های امنیتی می باشند باخبر شوید پس برای حفظ امنیت سایت و مطلع شدن از آخرین اخبار وردپرس، حتما در خبرنامه مشترک شوید. </p>
                <h3>آمار</h3>
