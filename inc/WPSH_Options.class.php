...
class WPSH_Options extends WPSH_Core
{
    ...
    public function register()
    {
        ...
        else
        {
          ...
          <p>
          برای باخبر شدن از آخرین اخبار، بروزرسانی ‎ها و آموزش ‎های وردپرس به زبان فارسی با وارد کردن ایمیل خود در فیلد زیر مشترک خبرنامه شوید.
          </p>
          ';
        }
        ...
        $fields[] = array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'default' => 'no',
                    'after' => '<p>با فعال کردن این گزینه اطلاعات نصب وردپرس ارسال خواهد شد. این اطلاعات به ما کمک می کند تا افزونه را بهتر و دقیق تر توسعه بدهیم تا بیشترین سازگاری را با خواسته های جامعه وردپرس فارسی داشته باشد. برای دریافت جزئیات از قسمت درباره ما، بند "حریم شخصی" را مطالعه کنید</p>',
        ...
        $fields[] = array(
            ...
            'fields' => array(
                ...
                <h2>حریم شخصی</h2>
                <p>"افزونه تاریخ شمسی و فارسی ساز وردپرس" در ادامه "این افزونه" نام برده خواهد شد.</p>
                <p>این افزونه هیچگونه اطلاعات و داده ای را بدون اجازه شما جمع آوری نمی کند. اطلاعات جمع آوری شده درصورت اجازه شما با فعال سازی گزینه های مربوطه به دو دسته "خبرنامه" و "آمار" تقسیم می شوند.</p>
                <h3>خبرنامه</h3>
                <p>با وارد کردن "ایمیل" خود در خبرنامه و اشتراک در آن آخرین اخبار، بروزرسانی ها و آموزش ها و مباحث مرتبط با وردپرس توسط ایمیل به اطلاع شما رسانده خواهد شد.</p>
                <p>ما هم از خبرنامه هایی که روزانه ده ها ایمیل ارسال می کنند متنفریم! پس نگران نباشید به طور میانگین هفتگی بیش از 1 الی 2 ایمیل ارسال نخواهد شد.</p>
                <p>عضویت در خبرنامه به شما این امکان را می دهد تا هرچه سریع تر از بروزرسانی های وردپرس که گاها برخی بروزرسانی های امنیتی می باشند باخبر شوید پس برای حفظ امنیت سایت و مطلع شدن از آخرین اخبار وردپرس، حتما در خبرنامه مشترک شوید. </p>
                <h3>آمار</h3>
                <p>با ارسال آمار وردپرس خود به این افزونه، کمک فراوانی به ما در توسعه و برنامه نویسی این افزونه خواهید کرد.</p>
                <p>این آمار چه استفاده ای دارند؟ با استفاده از این آمار تصمیم میگیریم که چه امکانات و سازگاری هایی را در نسخه های آتی به این افزونه اضافه کنیم تا رضایت اکثریت را به دنبال داشته باشد.</p>
                <p>چه داده هایی در این آمار ارسال می شود؟ لیست افزونه های فعال و قالب وردپرس، تنظیمات این افزونه، نام و توضیحات و ایمیل، نسخه این افزونه و نسخه وردپرس، نسخه پی اچ پی.</p>
                <p>با فعال سازی گزینه ارسال آمار در این افزونه می پذیرید که وبسایت wpvar.com و این افزونه اجازه دسترسی و استفاده از آمار وردپرس سایت شما را دارد.</p>
