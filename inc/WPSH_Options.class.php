    ...
    public function register()
    {
        ...
        $fields[] = array(
            ...
            'fields' => array(
                ...
                <h2>حریم خصوصی</h2>
                <p>وبسایت به معنی وبگاه، آدرس اینترنتی و سایت به کار برده خواهد شد.</p>
                ...
                <p>از وبسایت افرادی که به این صفحه دسترسی مدیریتی دارند “وبسایت شما” نام برده خواهد شد. دسترسی به این صفحه به معنی داشتن دسترسی مدیریت و حق مالکیت بر وبسایت می‌باشد. اگر کاربری مدیر وبسایت محسوب نمی‌شود، نباید به این صفحه دسترسی بدهید.</p>
                ...
                <p>هرموقع که بخواهید، از طریق لینک موجود در ایمیل‌های راسالی می‌توانید اشتراک خود را لغو کنید.</p>
                ...
                <p>چه داده‌هایی در این آمار ارسال می‌شود؟ لیست افزونه‌های فعال و قالب وردپرس، تنظیمات افزونه، نام و توضیحات و ایمیل وبسایت شما، نسخه افزونه و نسخه وردپرس، نسخه پی اچ پی وبسایت شما.</p>
