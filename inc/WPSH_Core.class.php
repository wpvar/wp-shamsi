  ...
  public function themes($theme)
  {
    ...
    if ($theme != 'wp-admin') {
      ...
      if (!$this->pro() || !$this->option('activate-fonts', true, false) || !$this->option('activate-font-admin', true, true)) {
        ...
        ';
        $css .= '
        #wpwrap h1, #wpwrap h2, #wpwrap h3, #wpwrap h4, #wpwrap h5, #wpwrap h6, #wpwrap p, #wpwrap div, #wpwrap a, #wpwrap code, #wpwrap li, #wpwrap ul, #wpwrap strong, #wpwrap select, #wpwrap option, #wpwrap button, p, #wpwrap input, #wpwrap body {
