...
<span class="exopite-sof-attachment-media exopite-sof-attachment-media-js"
	data-media-id="<?php echo esc_attr($image->ID); ?>"><span
		...
		class="exopite-sof-attachment-media-delete exopite-sof-attachment-media-delete-js"><i class="fa fa-times"
			aria-hidden="true"></i></span><img
		src="<?php echo wp_get_attachment_image_src(esc_attr($image->ID), 'thumbnail')[0]; ?>" /></span>
<?php }
